...
const Form = () => {
  ...
  return (
    <div className="flex flex-col justify-start items-center px-4 h-screen w-4/5 space-y-4">
      ...
      <div className="relative font-medium text-black flex flex-col w-full space-y-4">
        {formContent.map((field) => {
          return (
            <div
              key={field.id}
              className="rounded-md font-medium text-black flex w-full shadow-md px-4"
            >
              <div className="flex flex-col w-full">
                <div className="flex justify-between items-center space-y-2">
                  ...
                  <div>
                    <select
                      className="text-black" // Add this line to set the text color to black
                      onChange={(e) =>
